...
class QuadrotorAccelerationController(QuadrotorController):
    ...
    def __init__(self, pos_handler: str=None, pos_topic: str=None, update_frequency = 100.0, mass: float=0.03):
        super().__init__(pos_handler, pos_topic, update_frequency, mass)
