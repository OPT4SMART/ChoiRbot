...
def generate_launch_description():
    ap = argparse.ArgumentParser(prog='ros2 launch choirbot_examples rl.launch.py')
    ...
    for i in range(N):
        ...
        launch_description.append(Node(
            package='choirbot_examples', node_executable='choirbot_rl_guidance', output='screen',
