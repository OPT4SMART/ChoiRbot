...
def generate_launch_description():
    ...
    for i in range(N):
        ...
        #     package='choirbot_examples', node_executable='choirbot_unicycleintegrator', output='screen',
        #     node_namespace='agent_{}'.format(i),
        #     prefix=['xterm -hold -e'],
        #     parameters=[{'agent_id': i, 'init_pos': initial_pos}]))

        list_description.append(Node(
            package='choirbot_examples', node_executable='choirbot_unicycle_vel', output='screen',
            node_namespace='agent_{}'.format(i),
            #prefix=['xterm -hold -e'],
